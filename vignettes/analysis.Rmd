...
geop_sig <- brick(
  calc(geop_jfm, fun=function(x) cortest(x, k = 1)),
  calc(geop_jfm, fun=function(x) cortest(x, k = 2)),
  calc(geop_jfm, fun=function(x) cortest(x, k = 3)),
  calc(geop_jfm, fun=function(x) cortest(x, k = 4))) %>%
  `names<-`(paste0('PC', 1:4))
