...
```{r}
write_csv(cv_eot, 'cv_eot2.csv')
write_csv(cv_cca, 'cv_cca2.csv')
write_csv(cv_pcr, 'cv_pcr2.csv')
write_csv(cv_gam, 'cv_gam2.csv')
```


```{r}
cv_cca <- read_csv('cv_cca2.csv')
cv_eot <- read_csv('cv_eot2.csv')
cv_gam <- read_csv('cv_pcr2.csv')
cv_pcr <- read_csv('cv_gam2.csv')
```
