...
sst_jfm %>% filter(year == 1985) %>%
  ggplot(aes(x, y, fill = value)) + geom_raster() + coord_quickmap()
```
...
```{r}
save(prism_dat, cera_dat, cesm_dat, ccsm_dat, areas_prism, areas_cera, states_wus, world, file = '../data.Rdata')
```
