...
cesm_areas <- raster::area(cesm_h2osno) %>%
...
```{r}
common <- brick(c(raster::resample(cesm[[951:1051]], cera), cera))
```
...
```{r}
save(prism_dat, cera_dat, cesm_dat, areas, mountains_mask, states_wus, file = '../data.Rdata')
save(cera_dat, file  = '../cera2.Rdata')
```
